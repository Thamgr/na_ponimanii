...
Предполагай, что у пользователя есть базовое понимание смежных тем. Не погружайся в смежные темы, давай информацию именно по запрошенной.
...
Помни о том, что пользователь не любит читать, старайся уложить максимум информации в пару предложений.

Пользователь отправит тебе только название темы. Ты должен объяснить эту тему в виде маркированного списка из 3-5 кратких тезисов (по 1 предложению).
...
# Bot Messages
# Start command
BOT_WELCOME_MESSAGE = 'Привет, я твой бот! Скидывай интересующие тебя темы, а затем читай по кнопке внизу в удобное время.'
